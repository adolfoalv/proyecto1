...
public class VistaTrabajador extends javax.swing.JInternalFrame{
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(41, 43, 45)), "Registro de Trabajadores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Serif", 3, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        txtpaswword.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtpaswwordActionPerformed(evt);
            }
        });
        ...
        cboacceso1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Digitador" }));
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(cboestado, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtlogin, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtpaswword, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(cboacceso1, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(41, 43, 45)), "Lista de Trabajadores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Serif", 3, 14), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        txtpaswword.setText(tablalistado.getValueAt(fila, 12).toString());
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        if (txtnombre.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa el nombre del Trabajador");
            txtnombre.requestFocus();
            return;
        }
        if (txtapaterno.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa el Apellido Paterno del Trabajador");
            txtapaterno.requestFocus();
            return;
        }

        if (txtamaterno1.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa el Apellido Materno del Trabajador");
        ...
        if (txtsueldo.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa el sueldo del Cliente");
            txtsueldo.requestFocus();
            return;
        }
        if (txtlogin.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa el login del Trabajador");
            txtlogin.requestFocus();
            return;
        }
        if (txtpaswword.getText().length() == 0) {
            JOptionPane.showConfirmDialog(rootPane, "Ingresa un password para el Trabajador");
            txtpaswword.requestFocus();
            return;
        }
        ...
        dts.setSueldo(Double.valueOf(txtsueldo.getText()));
        ...
        dts.setPassword(txtpaswword.getText());
        ...
        if (accion.equals("guardar")) {
            ...
            if (func.editar(dts)) {
                JOptionPane.showMessageDialog(rootPane, "El Trabajador se edito Exitosamente");
                mostrar("");
                inhabilitar();
    ...
    private void txtpaswwordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtpaswwordActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtpaswwordActionPerformed
    ...
    private javax.swing.JComboBox<String> cboacceso1;
